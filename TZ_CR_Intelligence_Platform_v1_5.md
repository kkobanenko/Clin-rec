...
- Additive operator follow-up уже расширен recent UI task tracking, pipeline run detail picker и pipeline stage filter без изменения compatibility contract.
