...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "Document Linkage": {"ru": "Связи документа", "en": "Document Linkage"},
    "Current document version ID: {id}": {"ru": "Текущий ID версии документа: {id}", "en": "Current document version ID: {id}"},
    "Load Evidence For Current Version": {"ru": "Загрузить evidence для текущей версии", "en": "Load Evidence For Current Version"},
    "Evidence rows: {count}": {"ru": "Строк evidence: {count}", "en": "Evidence rows: {count}"},
    "Current document version is unavailable for linkage": {"ru": "Текущая версия документа недоступна для linkage", "en": "Current document version is unavailable for linkage"},
    ...
    "Download unavailable": {"ru": "Скачивание недоступно", "en": "Download unavailable"},
    ...
    "No evidence rows for current version": {"ru": "Для текущей версии нет строк evidence", "en": "No evidence rows for current version"},
    "Inline preview is not supported for this artifact type; use Download.": {"ru": "Inline-предпросмотр для этого типа артефакта не поддерживается; используйте Скачать.", "en": "Inline preview is not supported for this artifact type; use Download."},
    ...
    "Run Linkage": {"ru": "Связи прогона", "en": "Run Linkage"},
    "Run touched document IDs: {ids}": {"ru": "Прогон затронул document ID: {ids}", "en": "Run touched document IDs: {ids}"},
    "Run touched document IDs are not available": {"ru": "ID документов прогона недоступны", "en": "Run touched document IDs are not available"},
    "Load Latest Outputs For Run Follow-Up": {"ru": "Загрузить последние outputs для follow-up", "en": "Load Latest Outputs For Run Follow-Up"},
    "Use Tasks page with pipeline origin filter to inspect related task states": {"ru": "Используйте страницу задач с фильтром pipeline origin для проверки связанных task states", "en": "Use Tasks page with pipeline origin filter to inspect related task states"},
    "All": {"ru": "Все", "en": "All"},
    ...
    "Diff Linkage": {"ru": "Связи diff", "en": "Diff Linkage"},
    "Pair {from_id}->{to_id}": {"ru": "Пара {from_id}->{to_id}", "en": "Pair {from_id}->{to_id}"},
    "Changed Pair": {"ru": "Измененная пара", "en": "Changed Pair"},
    "Load Evidence For Changed Pair": {"ru": "Загрузить evidence для измененной пары", "en": "Load Evidence For Changed Pair"},
    ...
    "Output Linkage": {"ru": "Связи output", "en": "Output Linkage"},
    "Linked source document versions: {ids}": {"ru": "Связанные версии source-документов: {ids}", "en": "Linked source document versions: {ids}"},
    "Load Evidence For Linked Source Version": {"ru": "Загрузить evidence для связанной source-версии", "en": "Load Evidence For Linked Source Version"},
    "No source document versions linked to this artifact": {"ru": "Для этого артефакта нет связанных версий source-документов", "en": "No source document versions linked to this artifact"},
    ...
    "Claim Linkage": {"ru": "Связи claim", "en": "Claim Linkage"},
    "#{id} | artifact {artifact_id} | {claim_type}": {"ru": "#{id} | артефакт {artifact_id} | {claim_type}", "en": "#{id} | artifact {artifact_id} | {claim_type}"},
    "Current Claim": {"ru": "Текущий claim", "en": "Current Claim"},
    "Manual Claim ID": {"ru": "Ввести ID claim вручную", "en": "Manual Claim ID"},
    "Load Claim Artifact": {"ru": "Загрузить артефакт claim", "en": "Load Claim Artifact"},
    "Load Evidence For Claim Source Version": {"ru": "Загрузить evidence для source-версии claim", "en": "Load Evidence For Claim Source Version"},
    ...
    "pending_review": {"ru": "ожидает ревью", "en": "pending_review"},
    "approved": {"ru": "подтверждено", "en": "approved"},
    "released": {"ru": "выпущено", "en": "released"},
